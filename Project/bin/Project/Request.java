...
class Request implements Comparable<Request>{
	...
	public boolean equals(Request r) {
		if(this.startPos == r.startPos && this.finishPos == r.startPos && this.pickTime == r.pickTime) return true;
		return false;
	}
	...
	public String toString() {
		return "StartPos: " + startPos + ", finishPos: " + finishPos + "; (" + pickTime + "," + finishTime + "); " + "f-value: " + f_val;
	}
