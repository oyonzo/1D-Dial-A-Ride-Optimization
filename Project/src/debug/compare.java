...
//				System.out.println("\nALG with best combination takes "+ (endTime - startTime)/100000.0 + " Millisecond");
				...
				/*
				 * EDIT: this now runs make path, without the optimal combination of weights
				 */
...
//				System.out.println("Set size: " + sr.set.size() + " ShareRides size: " + sr.shareRides.size());
...
//				
			...
			System.out.println("\n");
			System.out.println("The Average Runtime over " + totIterations + " iterations was: \n" + "Alg: " + AvgRuntimeAlg + " Make Path without optimal weights: " + AvgRuntimeSR + "  Make Path: " + AvgRuntimeMP);
			System.out.println();
			System.out.println("The Average number of requests served over " + totIterations + " iterations was: \n" + "Alg: " + AvgReqAlg + " Make Path without optimal weights: " + AvgReqSR + "  Make Path with optimal weights: " + AvgReqMP);
