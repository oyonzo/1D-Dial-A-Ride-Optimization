...
public class MinFValue {
    ...
    public void minFValue(List<Request> requestList, List<Driver> driverList) {
        ...
        // Step 1: Assign each driver the (at most) n/k requests with the closest pickup
        // locations
        ...
        // Step 3: For any request assigned to more than one driver, assign to the
        // closest driver
    ...
    // test for both random and hard coded drivers and requests (see line 275)
