...
public class Shortest {
	 private static final int THRESHOLD = 1;
	    ...
	    public void shortest(List<Request> requestList, List<Driver> driverList) {
	        ...
	        Collections.sort(requestList, Comparator.comparingDouble(request -> request.weight));
...
//	    }
		...
		public static void main(String[] args) {
			...
			Shortest program = new Shortest();
			program.shortest(requestList_random, driverList_random);
			
			
			System.out.println(program.totalRequestsDone(driverList_random));
