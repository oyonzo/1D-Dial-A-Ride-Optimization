...
public class Graph {
	...
	// Set the time limit of the simulation
	static int TLIMIT = 1440;
	...
	// prints the fixed list of points
	...
	// generates a hardcoded list of locations
	public static double[][] generateFixedList() {
		double[][] coordinatesList = new double[][] {
				...
				{ 11.246204778898193, 36.64766052587953 },
